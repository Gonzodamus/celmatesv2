  ...
  return (
    <div className="About_Container">
      ...
      <p className="About_Copy">
        ...
        Cras ultrices imperdiet rhoncus. Vivamus luctus laoreet justo, porttitor
        condimentum lacus porta sit amet. Integer fermentum porttitor tortor ut
        tristique. Curabitur mollis ac metus sit amet vehicula. Phasellus ut dui
        suscipit, consectetur libero non, semper velit. Sed vel rutrum orci, ac
        venenatis enim. Proin tristique tortor vitae justo molestie ultricies.
